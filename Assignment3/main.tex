...
\begin{align}
\pr{X = a} = F(a) \label{formula1}
\end{align}
where $F(x)$ is the c.d.f of X and is given by:
\begin{align}
...
Thus, from \eqref{formula1} and \eqref{cdf}, we get:
\begin{align}
    \pr{X = 0.5} = 0.6
    \\
    \pr{X = 5} =1
    ...
    Thus,
    \begin{multline}
    \pr{0.5 \leq X \leq 5} \\ =\pr{X = 5} - \pr{X = 0.5} = 0.4
    \end{multline}
